...
1. Download application based on your platform (Linux, macOS and Windows): [Download the latest release](https://github.com/uuware/icons-font-desktop)
...
# 怎么使用
1. 请去这儿下载适合您当前系统 (Windows, Linux 和 MacOS) 的程序: [最新程序](https://github.com/uuware/icons-font-desktop)
2. 运行它，就这么简单
